...
6. Reminder, warning, moderation, messaging, archive, and restoration actions create history.
7. Owner Needs Attention aggregates exceptional work without exposing private data publicly.

All queues are button-driven and require confirmation for final or sensitive actions.
